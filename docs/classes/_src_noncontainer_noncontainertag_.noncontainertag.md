...
> [README](../README.md) / [Globals](../globals.md) / ["src/nonContainer/nonContainerTag"](../modules/_src_noncontainer_noncontainertag_.md) / NonContainerTag
...
* [joinedPerformersSort](_src_noncontainer_noncontainertag_.noncontainertag.md#joinedperformerssort)
...
* [isNullOrLikeEmpty](_src_noncontainer_noncontainertag_.noncontainertag.md#isnullorlikeempty)
...
\+ **new NonContainerTag**(`file`: [NonContainerFile](_src_noncontainer_noncontainerfile_.noncontainerfile.md)): [NonContainerTag](_src_noncontainer_noncontainertag_.noncontainertag.md)

*Overrides [CombinedTag](_src_combinedtag_.combinedtag.md).[constructor](_src_combinedtag_.combinedtag.md#constructor)*

*Defined in src/nonContainer/nonContainerTag.ts:14*
...
------ | ------ | ------ |
`file` | [NonContainerFile](_src_noncontainer_noncontainerfile_.noncontainerfile.md) | File to pull tags from  |
...
*Defined in src/nonContainer/nonContainerTag.ts:36*
...
*Defined in src/nonContainer/nonContainerTag.ts:41*
...
*Defined in src/nonContainer/nonContainerTag.ts:56*
...
*Defined in src/nonContainer/nonContainerTag.ts:46*
...
*Defined in src/nonContainer/nonContainerTag.ts:68*
...
*Defined in src/nonContainer/nonContainerTag.ts:100*
...
*Defined in src/nonContainer/nonContainerTag.ts:111*
...
*Defined in src/nonContainer/nonContainerTag.ts:119*
...
*Defined in src/nonContainer/nonContainerTag.ts:89*
...
Name | Type | Description |
------ | ------ | ------ |
`types` | [TagTypes](../enums/_src_tag_.tagtypes.md) | Tag types to be removed from the file. To remove all tags from a file, use     {@see TagTypes.AllTags}  |
...
*Defined in src/nonContainer/nonContainerTag.ts:129*
