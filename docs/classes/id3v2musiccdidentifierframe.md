...
▸ `Static`**fromOffsetRawData**(`data`: [*ByteVector*](bytevector.md), `offset`: *number*, `header`: [*Id3v2FrameHeader*](id3v2frameheader.md), `version`: *number*): [*Id3v2MusicCdIdentifierFrame*](id3v2musiccdidentifierframe.md)
...
**Returns:** [*Id3v2MusicCdIdentifierFrame*](id3v2musiccdidentifierframe.md)

___

### fromRawData

▸ `Static`**fromRawData**(`data`: [*ByteVector*](bytevector.md), `version`: *number*): [*Id3v2MusicCdIdentifierFrame*](id3v2musiccdidentifierframe.md)
