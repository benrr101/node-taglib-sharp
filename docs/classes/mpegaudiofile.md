...
\+ **new MpegAudioFile**(`file`: *string* \| IFileAbstraction, `propertiesStyle`: [*ReadStyle*](../enums/readstyle.md)): [*MpegAudioFile*](mpegaudiofile.md)
...
**Returns:** [*MpegAudioFile*](mpegaudiofile.md)
...
Name | Type | Default value | Description |
------ | ------ | ------ | ------ |
`pattern` | [*ByteVector*](bytevector.md) | - | Pattern to search for in the current instance. Must be shorter than the     [bufferSize](mpegaudiofile.md#buffersize)   |
