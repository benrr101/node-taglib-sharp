...
> [README](../README.md) / [Globals](../globals.md) / ["src/id3v2/frames/unknownFrame"](../modules/_src_id3v2_frames_unknownframe_.md) / UnknownFrame
...
* [\_header](_src_id3v2_frames_unknownframe_.unknownframe.md#_header)
* [data](_src_id3v2_frames_unknownframe_.unknownframe.md#data)

### Accessors

* [encryptionId](_src_id3v2_frames_unknownframe_.unknownframe.md#encryptionid)
* [flags](_src_id3v2_frames_unknownframe_.unknownframe.md#flags)
* [frameClassType](_src_id3v2_frames_unknownframe_.unknownframe.md#frameclasstype)
* [frameId](_src_id3v2_frames_unknownframe_.unknownframe.md#frameid)
* [groupId](_src_id3v2_frames_unknownframe_.unknownframe.md#groupid)
* [size](_src_id3v2_frames_unknownframe_.unknownframe.md#size)

### Methods

* [clone](_src_id3v2_frames_unknownframe_.unknownframe.md#clone)
* [fieldData](_src_id3v2_frames_unknownframe_.unknownframe.md#fielddata)
* [parseFields](_src_id3v2_frames_unknownframe_.unknownframe.md#parsefields)
* [render](_src_id3v2_frames_unknownframe_.unknownframe.md#render)
* [renderFields](_src_id3v2_frames_unknownframe_.unknownframe.md#renderfields)
* [setData](_src_id3v2_frames_unknownframe_.unknownframe.md#setdata)
* [correctEncoding](_src_id3v2_frames_unknownframe_.unknownframe.md#correctencoding)
* [fromData](_src_id3v2_frames_unknownframe_.unknownframe.md#fromdata)
* [fromOffsetRawData](_src_id3v2_frames_unknownframe_.unknownframe.md#fromoffsetrawdata)
* [fromRawData](_src_id3v2_frames_unknownframe_.unknownframe.md#fromrawdata)
...
*Defined in src/id3v2/frames/unknownFrame.ts:78*
...
*Defined in src/id3v2/frames/unknownFrame.ts:73*
...
*Defined in src/id3v2/frames/unknownFrame.ts:81*
...
*Defined in src/id3v2/frames/unknownFrame.ts:86*
...
*Defined in src/id3v2/frames/unknownFrame.ts:91*
...
▸ `Static`**fromData**(`identifier`: [FrameIdentifier](_src_id3v2_frameidentifiers_.frameidentifier.md), `data?`: [ByteVector](_src_bytevector_.bytevector.md)): [UnknownFrame](_src_id3v2_frames_unknownframe_.unknownframe.md)

*Defined in src/id3v2/frames/unknownFrame.ts:20*
...
Name | Type | Description |
------ | ------ | ------ |
`identifier` | [FrameIdentifier](_src_id3v2_frameidentifiers_.frameidentifier.md) | ID3v2 frame identifier |
`data?` | [ByteVector](_src_bytevector_.bytevector.md) | Contents of the frame  |

**Returns:** [UnknownFrame](_src_id3v2_frames_unknownframe_.unknownframe.md)

___

### fromOffsetRawData

▸ `Static`**fromOffsetRawData**(`data`: [ByteVector](_src_bytevector_.bytevector.md), `offset`: number, `header`: [Id3v2FrameHeader](_src_id3v2_frames_frameheader_.id3v2frameheader.md), `version`: number): [UnknownFrame](_src_id3v2_frames_unknownframe_.unknownframe.md)

*Defined in src/id3v2/frames/unknownFrame.ts:41*
...
▸ `Static`**fromRawData**(`data`: [ByteVector](_src_bytevector_.bytevector.md), `version`: number): [UnknownFrame](_src_id3v2_frames_unknownframe_.unknownframe.md)

*Defined in src/id3v2/frames/unknownFrame.ts:63*
