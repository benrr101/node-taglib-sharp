...
\+ **new AsfContentDescriptor**(`name`: *string*, `type`: [*AsfObjectDataType*](../enums/asfobjectdatatype.md), `value`: DescriptorValue): [*AsfContentDescriptor*](asfcontentdescriptor.md)
...
▸ `Static`**fromFile**(`file`: [*File*](file.md)): [*AsfContentDescriptor*](asfcontentdescriptor.md)
