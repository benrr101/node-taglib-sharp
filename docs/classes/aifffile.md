...
▪ `Static` `Readonly` **aiffFormType**: [`ByteVector`](bytevector.md)
...
▪ `Static` `Readonly` **commIdentifier**: [`ByteVector`](bytevector.md)
...
▪ `Static` `Readonly` **id3Identifier**: [`ByteVector`](bytevector.md)
...
▪ `Static` `Readonly` **soundIdentifier**: [`ByteVector`](bytevector.md)
