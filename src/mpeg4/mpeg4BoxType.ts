...
export default class Mpeg4BoxType {
    ...
    public static readonly Alb: ByteVector = Mpeg4Utils.fixId(ByteVector.fromString("alb", StringType.UTF8)).makeReadOnly();
    public static readonly Art: ByteVector = Mpeg4Utils.fixId(ByteVector.fromString("ART", StringType.UTF8)).makeReadOnly();
    public static readonly Cmt: ByteVector = Mpeg4Utils.fixId(ByteVector.fromString("cmt", StringType.UTF8)).makeReadOnly();
    ...
    public static readonly Day: ByteVector = Mpeg4Utils.fixId(ByteVector.fromString("day", StringType.UTF8)).makeReadOnly();
    ...
    public static readonly Gen: ByteVector = Mpeg4Utils.fixId(ByteVector.fromString("gen", StringType.UTF8)).makeReadOnly();
    public static readonly Gnre: ByteVector = ByteVector.fromString("gnre", StringType.UTF8).makeReadOnly();
    public static readonly Grp: ByteVector = Mpeg4Utils.fixId(ByteVector.fromString("grp", StringType.UTF8)).makeReadOnly();
    public static readonly Hdlr: ByteVector = ByteVector.fromString("hdlr", StringType.UTF8).makeReadOnly();
    public static readonly Lyr: ByteVector = Mpeg4Utils.fixId(ByteVector.fromString("lyr", StringType.UTF8)).makeReadOnly();
    ...
    public static readonly Nam: ByteVector = Mpeg4Utils.fixId(ByteVector.fromString("nam", StringType.UTF8)).makeReadOnly();
    ...
    public static readonly Url: ByteVector = Mpeg4Utils.fixId(ByteVector.fromString("url", StringType.UTF8)).makeReadOnly();
    public static readonly Uuid: ByteVector = ByteVector.fromString("uuid", StringType.UTF8).makeReadOnly();
    public static readonly Wrt: ByteVector = Mpeg4Utils.fixId(ByteVector.fromString("wrt", StringType.UTF8)).makeReadOnly();
