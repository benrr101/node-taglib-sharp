...
export class MatroskaIds
{
    ...
    /**
     * Indicates a Matroska Track Flag Hearing Impaired EBML element.
     */
    public static readonly FLAG_HEARING_IMPAIRED = 0x55AB;

    /**
     * Indicates a Matroska Track Flag Visual Impaired EBML element.
     */
    public static readonly FLAG_VISUAL_IMPAIRED = 0x55AC;

    /**
     * Indicates a Matroska Track Flag Original EBML element.
     */
    public static readonly FLAG_ORIGINAL = 0x55AE;

    /**
     * Indicates a Matroska Track Flag Commentary element.
     */
    ...
    /**
     * Indicates a Matroska Language ITF element.
     */
    public static readonly LANGUAGE_IETF = 0x22B59D;
