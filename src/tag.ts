...
export abstract class Tag {
     ...
     * @desc The title is most commonly the name of the song, episode or a movie title. For example
     ...
     * @desc Possibly used to sort compilations or episodic content.
     ...
     * @desc This field gives a nice/short precision to the title, which is typically below the
     ...
     * @desc This is especially relevant for a movie. For example, for "Fear and Loathing in Las
     ...
     * @desc This field is most commonly called "Artists" in audio media or "Actors" in video
     ...
     * @desc This is used to provide more control over how the media is sorted. Typical uses are to
     ...
     * @desc This field is typically optional but aids in the sorting of compilations or albums
     ...
     * @desc This field represents the composers, song writers, script writers, or persons who
     ...
     * @desc This field represents the name of the album the media belongs to. In the case of a
     ...
     * @see album
     * @desc This field is typically optional but aids in sort of compilations or albums with
     *     similar titles.
     ...
     * @desc This field should be used to store user notes and comments. There is no constraint on
     ...
     * @desc Years greater than 9999 cannot be stored by most tagging formats and will be cleared
     ...
     * @desc This field contains a plain text representation of the lyrics or scripts with line
     ...
     * @desc This field contains a non-physical group to which the track belongs. In classical
     ...
     * instance.
     * @desc This field is useful for DJ's who are trying to beat match tracks. It should be
     ...
     * @desc This field is most useful for organizing classical music and movies.
     ...
     * @desc This field should be used for storing copyright information. It may be useful to show
     ...
     * @desc This field represents the MusicBrainz ArtistID, and is used to uniquely identify a
     ...
     * @desc This field represents the MusicBrainz ReleaseGroupID and is used to uniquely identify
     ...
     * @desc This field represents the MusicBrainz ReleaseGroupID and is used to uniquely identify
     *     a particular release group to which this track belongs.
     * @param value MusicBrainz ReelaseGroupID of the media represented by the current instance or
     *     `undefined` if no value is present
     */
     ...
     * @desc This field represents the MusicBrains ReleaseID and is used to uniquely identify a
     ...
     * @desc This field represents the MusicBrainz ReleaseArtistID, and is used to uniquely
     ...
     * current instance.
     * @desc This field represents the MusicBrainz TrackID and is used to uniquely identify a
     *     particular track.
     ...
     * @desc This field represents the MusicBrainz DiscID and is used to uniquely identify the
     ...
     * @desc This field represents the MusicIP PUID, an acoustic fingerprint identifier. It
     ...
     * @desc This field represents the MusicIP PUID, an accoustic fingerprint identifier. It
     *     identifies wht this track "sounds like".
     ...
     * @desc This field represents the AmazonID, also called the ASIN, and is used to uniquely
     ...
     * @desc This field represents the MusicBrainz ReleaseStatus used to describe how 'official' a
     ...
     * @desc This field represents the MusicBrainz ReleaseType that describes what kind of release
     *     a release is. Common types are: `Single`, `Album`, `EP`, `Compilation`, `Soundtrack,
     *     `SpokenWord`, `Interview`, `Audiobook`, `Live`, `Remix`, and `Other`. Careeful thought
     ...
     * @desc This field represents the MusicBrainz ReleaseCountry which describes the country in
    ...
    /**
     * Gets the ReplyaGain track gain in dB.
    ...
    /**
     * Sets the ReplyaGain track gain in dB.
     ...
     * @desc Typically, this value is used to store an album cover or icon to use for the file, but
     ...
     * @returns First string contained in {@paramref group} or `undefined` if the array is
     *     `undefined` or empty
     * @protected
     */
     ...
     * @returns A semicolon and space separated string containing the values from {@paramref group}
     ...
     * @desc The clearing procedure is format specific and should clear all values.
     */
    public abstract clear(): void;

    /**
     * Set the tags that represent the tagger software (node-taglib-sharp) itself.
     * @desc This is typically a method to call just before saving a tag.
     */
     ...
     * @returns If {@paramref value} is a string, `true` is returned if the value is falsy or all
     *     whitespace, `false` is returned otherwise. If {@paramref value} is an array of strings,
