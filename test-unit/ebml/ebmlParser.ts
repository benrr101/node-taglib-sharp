...
class Ebml_ParserTests {
    @test
    public readUtf8StyleNumber_1ByteValue() {
        // Arrange
        ...
        // Act
        const result = parser["readUtf8StyleNumber"](8);
    ...
    @test
    public readUtf8StyleNumber_2ByteValue() {
        // Arrange
    ...
    @test
    public readUtf8StyleNumber_3ByteValue() {
        // Arrange
    ...
    @test
    public readUtf8StyleNumber_4ByteValue() {
        // Arrange
    ...
    @test
    public readUtf8StyleNumber_5ByteValue() {
        // Arrange
    ...
    @test
    public readUtf8StyleNumber_6ByteValue() {
        // Arrange
    ...
    @test
    public readUtf8StyleNumber_7ByteValue() {
        // Arrange
    ...
    @test
    public readUtf8StyleNumber_8ByteValue() {
        // Arrange
    ...
    @test
    public readUtf8StyleNumber_overflow() {
        // Arrange
        ...
        // Act / Assert
        assert.throws(() => parser["readUtf8StyleNumber"](8));
    }

    @test
    public readUtf8StyleNumber_tooFewBytes() {
        // Arrange
    ...
    @test
    public renderUtf8StyleNumber_1ByteValue() {
        // Arrange
        const file = TestFile.getFile(ByteVector.empty());
        const parser = new EbmlParser(file, 0);

        // Act
        const result = parser["renderUtf8StyleNumber"](0x3B);
    ...
    @test
    public renderUtf8StyleNumber_2ByteValue() {
        // Arrange
        const file = TestFile.getFile(ByteVector.empty());
        const parser = new EbmlParser(file, 0);

        // Act
        const result = parser["renderUtf8StyleNumber"](0x2AAA);
    ...
    @test
    public renderUtf8StyleNumber_3ByteValue() {
        // Arrange
        const file = TestFile.getFile(ByteVector.empty());
        const parser = new EbmlParser(file, 0);

        // Act
        const result = parser["renderUtf8StyleNumber"](0x167AA5);
    ...
    @test
    public renderUtf8StyleNumber_4ByteValue() {
        // Arrange
        const file = TestFile.getFile(ByteVector.empty());
        const parser = new EbmlParser(file, 0);

        // Act
        const result = parser["renderUtf8StyleNumber"](0x0C167AA5);
    ...
    @test
    public renderUtf8StyleNumber_5ByteValue() {
        // Arrange
        const file = TestFile.getFile(ByteVector.empty());
        const parser = new EbmlParser(file, 0);

        // Act
        const result = parser["renderUtf8StyleNumber"](0x066C167AA5);
    ...
    @test
    public renderUtf8StyleNumber_6ByteValue() {
        // Arrange
        const file = TestFile.getFile(ByteVector.empty());
        const parser = new EbmlParser(file, 0);

        // Act
        const result = parser["renderUtf8StyleNumber"](0x03286C167AA5);
    ...
    @test
    public renderUtf8StyleNumber_7ByteValue() {
        // Arrange
        const file = TestFile.getFile(ByteVector.empty());
        const parser = new EbmlParser(file, 0);

        // Act
        const result = parser["renderUtf8StyleNumber"](0x0163286C167AA5);
    ...
    @test
    public renderUtf8StyleNumber_8ByteValue() {
        // Arrange
        const file = TestFile.getFile(ByteVector.empty());
        const parser = new EbmlParser(file, 0);

        // Act
        const result = parser["renderUtf8StyleNumber"](0x0F63286C167AA5);
    ...
    @test
    public renderUtf8StyleNumber_overflow() {
        // Arrange
        const file = TestFile.getFile(ByteVector.empty());
        const parser = new EbmlParser(file, 0);

        // Act / Assert
        assert.throws(() => parser["renderUtf8StyleNumber"](BigInt("9151314442816847872")));
    }
}
